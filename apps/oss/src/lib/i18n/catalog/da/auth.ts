export const daAuthMessages = {
  ...
  "auth.onboarding.select.title": "Vælg din organisation",
  "auth.onboarding.select.description": "Vælg en eksisterende organisation eller opret en ny.",
  "auth.onboarding.select.loading": "Indlæser dine organisationer…",
