export const daSettingsMessages = {
  ...
  "settings.documentSending.lastSyncedAt.label": "Sidst synkroniseret",
  "settings.documentSending.lastSyncSource.label": "Seneste synkroniseringskilde",
  "settings.documentSending.lastSyncSource.manual": "Manuel kontrol",
